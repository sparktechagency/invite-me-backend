...
const registerNormalUserValidationSchema = z.object({
    ...
    dateOfBirth: z.preprocess(
        ...
        z.date({ invalid_type_error: 'Invalid date format for dateOfBirth' })
    ),
    ...
    language: z
        .array(
            z.string({ invalid_type_error: 'Each language must be a string' }),
            {
    ...
    checkInDate: z.preprocess(
        ...
        z.date({ invalid_type_error: 'Invalid date format for checkInDate' })
    ),
    ...
    checkOutDate: z.preprocess(
        ...
        z.date({ invalid_type_error: 'Invalid date format for checkOutDate' })
    ),
});
